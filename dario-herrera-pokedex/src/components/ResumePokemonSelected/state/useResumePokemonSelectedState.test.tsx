...
import { useResumePokemonSelectedState } from "./useResumePokemonSelectedState";
...
describe("useResumePokemonSelectedStateK", () => {
  ...
  it("should return an state when useResumePokemonSelectedState is called", () => {
    const { result } = renderHook(() => useResumePokemonSelectedState());

    expect(result.current.pokemonType).toEqual([
      {
        slot: 1,
    ...
    expect(result.current.spriteArray).toEqual([
      "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/back/1.png",
      "",
      "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/back/shiny/1.png",
      "",
    ]);
    expect(result.current.mainPokemonImageSrc).toEqual(
      "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/1.svg"
    );
    expect(result.current.pokemonId).toEqual("# 1");
    expect(result.current.moveArray.length).toEqual(7);
    expect(result.current.pokemonWeight).toEqual("69 Kg");
    expect(result.current.pokemonName).toEqual("Bulbasaur");
  });
});
